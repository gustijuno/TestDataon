                ...
                <table class="table table-stripped myTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <center>
                                    <a href="{{ url('admin/manage-pengalaman/'.$pl->pengalaman_id) }}"><span class="glyphicon glyphicon-edit"></span></a>
                                    <a href="" data="{{ $pl->pengalaman_id }}" class="btn-hapus"><span class="glyphicon glyphicon-trash"></span></a>
                                </center>
                            </td>
                        </tr>
                        @endforeach
