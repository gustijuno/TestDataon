    ...
    <div class="col-md-12">
        <div class="box">
            <div class="box-body">
                ...
                <a href="{{ url('admin/manage-pendidikan/add') }}" class="btn btn-flat btn-primary"><span class="glyphicon glyphicon-plus"></span> Tambah Pengalaman</a>
                ...
                <table class="table table-stripped myTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <center>
                                    <a href="{{ url('admin/manage-pendidikan/'.$pl->id) }}"><span class="glyphicon glyphicon-edit"></span></a>
